...
public class UserService {
    ...
    * */
    ...
    public User signUp(String user_name, String password, String nickname){
        // 1. 사용자 이름 중복 확인
        if (userRepository.findByUser_name(user_name).isPresent()) {
    ...
    * */
    ...
    public User login(String user_name, String password){
        // 1. 사용자 ID로 user 조회
        User user = userRepository.findByUser_name(user_name).orElseThrow(() -> new IllegalArgumentException("없는 사용자이거나 비밀번호가 틀렸습니다."));
